...
**Status**: Shipped & healthy — shared "Manuscript" design system (npm `@quietbuildlab/ui@0.8.0`, 31+ Base UI + Tailwind v4 components, six themes). The most production-solid of the five; consumed by privacy-blur and my-nextjs-blog. OIDC publishing on tag push works.
...
- Add Renovate/Dependabot to keep consumers current (privacy-blur is on `^0.6.1`, blog on `^0.6.0`, vs `0.8.0` shipped).
