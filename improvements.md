...
1. **Close the consumer version lag with Renovate/Dependabot.** privacy-blur pins `^0.6.1` and my-nextjs-blog `^0.6.0` while `0.7.0` is shipped — automated dependency PRs would keep them current so new components (e.g. the v0.7.0 collapsible Sidebar) actually reach production.
